    ...
    var a = "white",
        t = function() {
            ...
            this.move = function(e) {
                ...
                "filled" != o.attr("data-filled") && "first" == $(e.target).data("step") && (console.log("first step"), t.step = "white" == a ? -2 : 2, $('.place[data-row="' + (parseInt(l) + t.step) + '"][data-num="' + d + '"]').addClass("active")), t.step = "white" == a ? -1 : 1, i = "white" == a ? -1 : 1, o = $('.place[data-row="' + (parseInt(l) + i) + '"][data-num="' + d + '"]'), "filled" != o.attr("data-filled") && $('.place[data-row="' + (parseInt(l) + t.step) + '"][data-num="' + d + '"]').addClass("active"), "filled" == $('.place[data-row="' + (parseInt(l) + t.step) + '"][data-num="' + (parseInt(d) + 1) + '"]').attr("data-filled") && $('.piece[data-row="' + (parseInt(l) + t.step) + '"][data-num="' + (parseInt(d) + 1) + '"]').hasClass(r) && $('.piece[data-row="' + (parseInt(l) + t.step) + '"][data-num="' + (parseInt(d) + 1) + '"]').addClass("killable"), "filled" == $('.place[data-row="' + (parseInt(l) + t.step) + '"][data-num="' + (parseInt(d) - 1) + '"]').attr("data-filled") && $('.piece[data-row="' + (parseInt(l) + t.step) + '"][data-num="' + (parseInt(d) - 1) + '"]').hasClass(r) && $('.piece[data-row="' + (parseInt(l) + t.step) + '"][data-num="' + (parseInt(d) - 1) + '"]').addClass("killable"), $(".active ").click(function(t) { $(e.target).data("step", "clear"), a = "white" == a ? "black" : "white", $(".place").removeClass("active"), $(".piece").removeClass("killable"), $(e.target).animate({ top: 50 * ($(t.target).attr("data-row") - 1) }, 200, function() { $('.place[data-row="' + l + '"][data-num="' + d + '"]').attr("data-filled", "none"), $(e.target).attr("data-row", $(t.target).attr("data-row")), $(t.target).attr("data-filled", "filled"), $(".place").off("click"), $(".piece").off("mousedown"), ("8" == $(t.target).attr("data-row") || "1" == $(t.target).attr("data-row")) && $(e.target).attr("data-piece", "Queen") }) }), $(".killable").mousedown(function(t) { $(e.target).data("step", "clear"), a = "white" == a ? "black" : "white", $(".place").removeClass("active"), $(".piece").removeClass("killable"), $(e.target).animate({ left: 50 * ($(t.target).attr("data-num") - 1), top: 50 * ($(t.target).attr("data-row") - 1) }, 200, function() { $('.place[data-row="' + l + '"][data-num="' + d + '"]').attr("data-filled", "none"), $(e.target).attr("data-row", $(t.target).attr("data-row")), $(e.target).attr("data-num", $(t.target).attr("data-num")), $('.place[data-row="' + $(t.target).attr("data-row") + '"][data-num="' + $(t.target).attr("data-num") + '"]').attr("data-filled", "filled"), $(".place").off("click"), $(".piece").off("mousedown"), $(t.target).remove(), $(".place").removeClass("active"), $(".piece").removeClass("killable") }) })
            }
        },
        e = function() {
            this.step;
            this.move = function(t) {
                ...
                console.log(d);
                for (var o = 0; 8 > o; o++) { var c = $('.place[data-row="' + d[o] + '"][data-num="' + i[o] + '"]'); "filled" == c.attr("data-filled") && $('.piece[data-row="' + d[o] + '"][data-num="' + i[o] + '"]').hasClass(e) ? $('.piece[data-row="' + d[o] + '"][data-num="' + i[o] + '"]').addClass("killable") : c.addClass("active") }
                $(".active ").click(function(e) { a = "white" == a ? "black" : "white", $(".place").removeClass("active"), $(".piece").removeClass("killable"), $(t.target).animate({ top: 50 * ($(e.target).attr("data-row") - 1), left: 50 * ($(e.target).attr("data-num") - 1) }, 200, function() { $('.place[data-row="' + l + '"][data-num="' + r + '"]').attr("data-filled", "none"), $(t.target).attr("data-row", $(e.target).attr("data-row")), $(t.target).attr("data-num", $(e.target).attr("data-num")), $(e.target).attr("data-filled", "filled"), $(".place").off("click"), $(".piece").off("mousedown") }) }), $(".killable").mousedown(function(e) { a = "white" == a ? "black" : "white", $(".place").removeClass("active"), $(".piece").removeClass("killable"), $(t.target).animate({ top: 50 * ($(e.target).attr("data-row") - 1), left: 50 * ($(e.target).attr("data-num") - 1) }, 200, function() { $('.place[data-row="' + l + '"][data-num="' + r + '"]').attr("data-filled", "none"), $(t.target).attr("data-row", $(e.target).attr("data-row")), $(t.target).attr("data-num", $(e.target).attr("data-num")), $('.place[data-row="' + $(e.target).attr("data-row") + '"][data-num="' + $(e.target).attr("data-num") + '"]').attr("data-filled", "filled"), $(".place").off("click"), $(".piece").off("mousedown"), $(e.target).remove(), $(".place").removeClass("active"), $(".piece").removeClass("killable") }) })
            }
        },
        l = function() {
            this.move = function(t) {
                ...
                for (var e = "white" == a ? "black" : "white", l = parseInt($(t.target).attr("data-row")), r = parseInt($(t.target).attr("data-num")), d = 1, i = 1; 8 >= l + i && 8 >= r + d; i++) {
                    ...
                    if ("filled" == o.attr("data-filled")) { findFilledColor(o, e, l + i, r + d); break }
                    o.addClass("active"), d++
                }
                for (d = 1, i = 1; l - i > 0 && r - d > 0; i++) {
                    if (o = $('.place[data-row="' + (l - i) + '"][data-num="' + (r - d) + '"]'), "filled" == o.attr("data-filled")) { findFilledColor(o, e, l - i, r - d); break }
                    o.addClass("active"), d++
                }
        ...
        r = function() {
            this.move = function(t) {
                ...
                for (var e = "white" == a ? "black" : "white", l = parseInt($(t.target).attr("data-row")), r = parseInt($(t.target).attr("data-num")), d = 1; 8 >= r + d; d++) {
                    ...
                    if ("filled" == o.attr("data-filled")) { findFilledColor(o, e, l, r + d); break }
                    o.addClass("active")
                }
                for (d = 1; r - d > 0; d++) {
                    if (o = $('.place[data-row="' + l + '"][data-num="' + (r - d) + '"]'), "filled" == o.attr("data-filled")) { findFilledColor(o, e, l, r - d); break }
                    o.addClass("active")
                }
                for (i = 1; l + i <= 8; i++) {
                    if (o = $('.place[data-row="' + (l + i) + '"][data-num="' + r + '"]'), "filled" == o.attr("data-filled")) { findFilledColor(o, e, l + i, r); break }
                    o.addClass("active")
                }
                for (i = 1; l - i > 0; i++) {
                    if (o = $('.place[data-row="' + (l - i) + '"][data-num="' + r + '"]'), "filled" == o.attr("data-filled")) { findFilledColor(o, e, l - i, r); break }
        ...
        o = function() {
            this.move = function(t) {
                ...
                "filled" == d.attr("data-filled") ? findFilledColor(d, e, l + 1, r + 1) : d.addClass("active"), d = $('.place[data-row="' + (l + 1) + '"][data-num="' + r + '"]'), "filled" == d.attr("data-filled") ? findFilledColor(d, e, l + 1, r) : d.addClass("active"), d = $('.place[data-row="' + (l + 1) + '"][data-num="' + (r - 1) + '"]'), "filled" == d.attr("data-filled") ? findFilledColor(d, e, l + 1, r - 1) : d.addClass("active"), d = $('.place[data-row="' + l + '"][data-num="' + (r - 1) + '"]'), "filled" == d.attr("data-filled") ? findFilledColor(d, e, l, r - 1) : d.addClass("active"), d = $('.place[data-row="' + l + '"][data-num="' + (r + 1) + '"]'), "filled" == d.attr("data-filled") ? findFilledColor(d, e, l, r + 1) : d.addClass("active"), d = $('.place[data-row="' + (l - 1) + '"][data-num="' + (r + 1) + '"]'), "filled" == d.attr("data-filled") ? findFilledColor(d, e, l - 1, r + 1) : d.addClass("active"), d = $('.place[data-row="' + (l - 1) + '"][data-num="' + r + '"]'), "filled" == d.attr("data-filled") ? findFilledColor(d, e, l - 1, r) : d.addClass("active"), d = $('.place[data-row="' + (l - 1) + '"][data-num="' + (r - 1) + '"]'), "filled" == d.attr("data-filled") ? findFilledColor(d, e, l - 1, r - 1) : d.addClass("active"), $(".active ").click(function(e) {
                    a = "white" == a ? "black" : "white", $(".place").removeClass("active"), $(".piece").removeClass("killable"), $(t.target).animate({ top: 50 * ($(e.target).attr("data-row") - 1), left: 50 * ($(e.target).attr("data-num") - 1) }, 200, function() {
                        function a() {}
                ...
                }), $(".killable").mousedown(function(e) { a = "white" == a ? "black" : "white", $(".place").removeClass("active"), $(".piece").removeClass("killable"), $(t.target).animate({ top: 50 * ($(e.target).attr("data-row") - 1), left: 50 * ($(e.target).attr("data-num") - 1) }, 200, function() { $('.place[data-row="' + l + '"][data-num="' + r + '"]').attr("data-filled", "none"), $(t.target).attr("data-row", $(e.target).attr("data-row")), $(t.target).attr("data-num", $(e.target).attr("data-num")), $('.place[data-row="' + $(e.target).attr("data-row") + '"][data-num="' + $(e.target).attr("data-num") + '"]').attr("data-filled", "filled"), $(".place").off("click"), $(".piece").off("mousedown"), $(e.target).remove(), $(".place").removeClass("active"), $(".piece").removeClass("killable") }) })
            }
        };
...
function SetPos() { $('.place[data-row="7"],.place[data-row="8"]').attr("data-pieceColor", "white").attr("data-filled", "filled"), $('.place[data-row="1"],.place[data-row="2"]').attr("data-pieceColor", "black").attr("data-filled", "filled") }
...
$(function() { DrawBoard(), SetPieces(), SetPos(), play() });
